...
chef.add_example(
    {"question": "When was it built?", "context": "The building was constructed in 1995."},
    {"spans": [{"text": "1995", "start": 39, "end": 43}]}
)

chef.add_example(
    {"question": "What year?", "context": "Established in 1987, it became famous worldwide."},
    {"spans": [{"text": "1987", "start": 13, "end": 17}]}
)

chef.add_example(
    {"question": "When did it happen?", "context": "The event occurred on January 15, 2001."},
